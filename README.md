...
- `Corefile` — CoreDNS configuration that defines IKANN root behavior  
...
The resolver will run on Fly’s anycast edge network, making `.kai` resolvable worldwide through your IKANN installation.
